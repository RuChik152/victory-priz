...
export class Auto1690796398282 implements MigrationInterface {
    name = 'Auto1690796398282'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`tag\` varchar(255) NOT NULL, \`presentation_name\` varchar(255) NOT NULL, \`art\` varchar(255) NOT NULL, \`price\` int NOT NULL, \`description\` text NOT NULL, \`image_data\` mediumblob NOT NULL, \`image_link\` varchar(255) NOT NULL, \`sales\` varchar(255) NOT NULL DEFAULT 'no-sales', \`sales_percent\` int NOT NULL DEFAULT '0', \`groupId\` varchar(36) NULL, \`typeId\` varchar(36) NULL, UNIQUE INDEX \`REL_9ff07d9b0075484eb946e79e56\` (\`groupId\`), UNIQUE INDEX \`REL_53bafe3ecc25867776c07c9e66\` (\`typeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_53bafe3ecc25867776c07c9e66\` ON \`product\``);
